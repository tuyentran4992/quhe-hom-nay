...
- [0.3-MKT-F6-fix] 2026-08-31 · t_a6fbf162 · whitelist +`donate_open`; landing CTA POST /api/track cta_gieo_que (PA1, GA4 chỉ phụ); SPA PaywallView POST donate_open props{topic}. QUY UOC DOC SO LOCKED: CVR GD1 = draws_devices/landing_visit_devices theo campaign (device-level); cot clicks + donate_opens = chan doan phu. SQL §6 viet lai theo cong thuc moi.
